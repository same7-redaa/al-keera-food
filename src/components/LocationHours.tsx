      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 reveal">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-primary/80 border border-brand-gold/30 text-brand-brightGold text-xs sm:text-sm font-bold mb-4 shadow-sm">
            ...
            <span>فرعان لخدمتكم + توصيل ساخن وسريع في جميع أنحاء المحلة</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6 mb-8">
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-7 border border-brand-gold/25 shadow-xl flex flex-col justify-between hover:border-brand-gold/50 transition-all duration-300 group text-center sm:text-right reveal delay-100">
            <div>
              ...
              <h3 className="text-lg font-black text-brand-cream mb-3">
                فروع مطعم الكيرة
              </h3>

              <div className="space-y-3 mb-4 text-xs sm:text-sm text-brand-cream/85">
                <div className="p-2.5 rounded-xl bg-brand-primary/40 border border-brand-gold/20">
                  <span className="text-brand-brightGold font-bold block mb-1">📍 فرع 1 (المشحمة):</span>
                  <span className="leading-relaxed">بجوار البنزينة واولاد رجب أعلى سنتر النصر أمام موسى للسيارات</span>
                </div>

                <div className="p-2.5 rounded-xl bg-brand-primary/40 border border-brand-gold/20">
                  <span className="text-brand-brightGold font-bold block mb-1">📍 فرع 2 (ش 6 أكتوبر):</span>
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-7 border border-brand-gold/40 shadow-xl flex flex-col justify-between bg-gradient-to-b from-brand-card to-brand-primary/40 text-center sm:text-right reveal delay-300">
            <div>
              ...
              <p className="text-xs sm:text-sm text-brand-cream/80 font-medium mb-3">
                تغليف حراري محكم يحافظ على سخونة المشويات والطواجن حتى بابك.
              </p>
              
              <div className="text-xs text-brand-brightGold font-bold mb-4 flex items-center justify-center sm:justify-start gap-2">
