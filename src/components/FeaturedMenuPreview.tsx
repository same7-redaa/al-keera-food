  ...
  return (
    <section id="featured-menu" className="py-12 sm:py-16 lg:py-20 relative bg-[#F6F2EA] overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Grid of Featured Dishes: 4 on desktop, 1 on mobile (Full Width) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-4 lg:gap-5 mb-12 w-full reveal delay-100">
